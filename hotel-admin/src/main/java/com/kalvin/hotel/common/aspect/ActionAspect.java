package com.kalvin.hotel.common.aspect;
...
import com.kalvin.hotel.modules.sys.service.ILogService;
...
public class ActionAspect {
	...
	@Pointcut("@annotation(com.kalvin.hotel.common.annotation.Log)")
	...
	private void saveActionLog(JoinPoint joinPoint, long time, boolean isAround) {
		...
		com.kalvin.hotel.modules.sys.entity.Log actionLog = new com.kalvin.hotel.modules.sys.entity.Log();
